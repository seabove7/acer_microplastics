...
Srar <- rarefy(seqtab_cleanest, raremax)
seqtab_rare <- rrarefy(seqtab_cleanest, raremax)
...
rownames(taxa2) <- paste0("ASV", seq(1, length(colnames(seqtab_rare))))
...
phylo_rare <- phyloseq(otu_table(seqtab_rare, taxa_are_rows = FALSE), 
               ...
               tax_table(taxa))
phylo_rare #2 346 taxa during revisions
