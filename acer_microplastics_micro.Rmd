...
phylo_rare # 2498 in 35 samples after pruning     (1503 in 19 samples)
...
## save figure 
ggsave("Figures/Exploratory/16S_abundance.png", height = 8, width = 15, dpi = 600)
ggsave("Figures/Exploratory/16S_abundance.pdf", height = 8, width = 15, useDingbats = FALSE)
