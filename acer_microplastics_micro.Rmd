...
save(seqtab_rare, file = "Data/16s_data/seqtab_rare9100.Rdata")
...
```{r calc rel abund and save phylo objc, fig.height = 6, fig.width = 4, fig.align = "center"}
...
```{r treatment level abundance, fig.height = 6, fig.width = 4, fig.align = "center"}
