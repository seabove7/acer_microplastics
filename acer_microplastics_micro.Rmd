...
```{r fig S4 rick ASVs, fig.align = 'center', fig.height = 7, fig.width = 8}
...
## save figure 
ggsave("Figures/Supplemental/FigureS4_RickettsialesASVs.png", height = 7, width = 8, dpi = 600)
ggsave("Figures/Supplemental/FigureS4_RickettsialesASVs.pdf", height = 7, width = 8, useDingbats = FALSE)

```

**Supplemental Figure 4:** Relative abundance of the four identified ASVs within order Rickettsiales across all samples. Samples were dominated by ASV 37, with background presence of the other 3 ASVs.
...
figS5 <- ggarrange(simp_stat_plot, shan_stat_plot, rich_stat_plot, even_stat_plot, common.legend = TRUE, labels = "AUTO", legend = "right") 
figS5

## save figure 
ggsave("Figures/Supplemental/FigureS5_alpha.png", height = 7, width = 8, dpi = 600)
ggsave("Figures/Supplemental/FigureS5_alpha.pdf", height = 7, width = 8, useDingbats = FALSE)

```

**Supplemental Figure 5:** Alpha diversity metrics across all samples in all treatments, depicting (**A**) Simpson index, (**B**) Shannon index, (**C**) species richness (ASVs), and (**D**) Evenness.
...
## Combine them
env_summary <- rbind(treat_summary, tank_summary)
...
kable(env_summary, row.names = FALSE, digits = 2, col.names = c(" ", rep(rep_list, 4))) %>% 
  ...
  add_header_above(c(" ", "Temperature" = 4, "Dissolved Oxygen" = 4, "Salinity" = 4, "pH" = 4)) %>%
  pack_rows("Treatment", 1, 4) %>%
  pack_rows("Tank", 5, 40) %>%
  column_spec(c(1,5,9,13), border_right = TRUE)
