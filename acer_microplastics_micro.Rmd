...
trim_rare_rel_phyla2 <- trim_rare_rel_phyla + 
  theme(strip.background = element_blank(), plot.title = element_blank())
...
```{r full fig 5, fig.height = 8, fig.width = 14}
...
## save figure 
ggsave("Figures/Figure5_16s_diversity.png", height = 8, width = 14, dpi = 600)
ggsave("Figures/Figure5_16s_diversity.pdf", height = 8, width = 14, useDingbats = FALSE)
