...
# subset for just archaea
ps_arch <- subset_taxa(ps_nomito, (Kingdom == "Archaea"))
...
Before proceeding, we are going to remove the samples that were identified as clones () and those with low reads for the gene expression analysis () to have matching samples. 
